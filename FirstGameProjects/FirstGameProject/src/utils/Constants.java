...
public class Constants {
	...
	public static class EnemyConstants{
		...
		public static final int SLIME_WIDTH = (int) (SLIME_WIDTH_DEFAULT * 1.5 * Game.SCALE);
		public static final int SLIME_HEIGHT = (int) (SLIME_HEIGHT_DEFAULT * 1.5 * Game.SCALE);
		
		public static final int SLIME_DRAWOFFSET_X = (int) (23 * 1.5 * Game.SCALE);
		public static final int SLIME_DRAWOFFSET_Y = (int) (23 * 1.5 * Game.SCALE);
